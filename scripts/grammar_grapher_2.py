...
This limitation also applies after options (e.g. --ignore) are applied.
...
import argparse
import sys
from typing import Any, Iterator, List, Set, Dict, Tuple
...
def main(args: argparse.Namespace) -> None:
    ...
    visitor = Visitor(grammar, terminals, args.reverse_alts)
    if args.subgraph:
