...
test_invalid_expression = Testcases([
...
test_invalid_statements = Testcases([
...
test_invalid_call_arguments = Testcases([
...
test_invalid_assignments = Testcases([
...
test_invalid_parameters = Testcases([
    (
        "def f(a=1, b):\n\tpass",
...
test_invalid_star_etc = Testcases.with_args(
...
test_invalid_try_stmt = Testcases.with_args(exc_cls=None).create([
    (
        "try:\npass",
        IndentationError,
...
test_invalid_except_stmt = Testcases.with_args(exc_cls=None).create([
    (
        "try:\n\tpass\nexcept:\npass",
...
test_invalid_if_stmt = Testcases.with_args(exc_cls=None).create([
    (
        "if a\n\tpass",
        SyntaxError,
        "expected ':'",
...
test_invalid_elif_stmt = Testcases.with_args(exc_cls=None).create([
    (
        "if a:\n\tpass\nelif a\n\tpass",
        SyntaxError,
        "expected ':'",
...
test_invalid_else_stmt = Testcases.with_args(exc_cls=None).create([
    (
        "if a:\n\tpass\nelse\n\tpass",
        SyntaxError,
        "expected ':'",
...
test_invalid_while_stmt = Testcases.with_args(exc_cls=None).create([
    (
        "while a\n\tpass",
        SyntaxError,
        "expected ':'",
...
test_invalid_for_stmt = Testcases.with_args(exc_cls=None).create([
    (
        "for a in range(10)\npass",
        SyntaxError,
        "expected ':'",
...
test_invalid_def_stmt = Testcases.with_args(exc_cls=None).create([
    (
        "def f():\npass",
        IndentationError,
...
test_invalid_class_stmt = Testcases.with_args(exc_cls=None).create([
    (
        "class A\npass",
        SyntaxError,
        "expected ':'",
